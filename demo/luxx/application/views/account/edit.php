				...
				<div class="box b-white p-all-30">
					...
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="form-button">
							<button class="btn b-secondary c-primary btn-block">Edit account [DISABLED]</button>
						</div>
					</form>
				</div>
			</div>
			...
			<div class="section">
				...
				<div class="box b-white p-all-30">
					...
					<form action="" method="post">
						...
						<div class="form-button">
							<button class="btn b-secondary c-primary btn-block">Update password [DISABLED]</button>
						</div>
					</form>
				</div>
			</div>
