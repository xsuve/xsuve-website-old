							...
							<div class="list-element p-bottom-15 p-top-15 <?php echo ($i == 0 ? 'first' : ''); ?> <?php echo ($i == (count($project_tasks) - 1) ? 'last' : ''); ?>">
								<div class="row">
									<div class="col-lg-7 text-left">
										...
										<div class="project-task-title caption <?php echo ($project_task->completed == true ? 'c-gray' : 'c-text'); ?>" data-task-id="<?php echo $project_task->id; ?>"><?php echo $project_task->title; ?></div>
									</div>
						...
						<?php if(count($task_categories) > 0): ?>
							<div class="form-input-box">
								...
								<select name="task_category_id" class="text c-text">
									<option value="" selected="selected" disabled="disabled">Select the task category</option>
						...
						<?php if(count($project_workers) > 0): ?>
							<div class="form-input-box">
								...
								<select name="task_worker_id" class="text c-text">
									<option value="" selected="selected" disabled="disabled">Select the project worker</option>
