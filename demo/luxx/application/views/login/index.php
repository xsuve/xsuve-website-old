	...
	<div class="box p-all-50 b-white v-middle">
		...
		<form action="<?php echo URL; ?>login/loginaccount" method="post">
			<div class="form-input-box">
				...
				<input type="email" name="email" placeholder="Enter the e-mail" class="text c-text" value="demo@email.com">
			</div>
			<div class="form-input-box">
				<div class="caption c-text m-bottom-5">Password</div>
				<input type="password" name="password" placeholder="Enter the password" class="text c-text" value="12345">
			</div>
