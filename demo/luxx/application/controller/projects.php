        ...
        if(isset($project_id) && $project_id != null) {
            if($project_id != 1) {
              ...
              if($project_data != false) {
                ...
                $_SESSION['alert'] = 'The demo project can not be edited.';
                header('location: ' . URL . 'projects/edit/' . $project_id);
            }
        } else {
          header('location: ' . URL . 'projects');
      ...
      if(isset($task_id) && $task_id != null) {
          if($task_id != 1) {
            if(isset($_POST['submit_edit_task'])) {
              ...
              $_SESSION['alert'] = 'The demo project task can not be edited.';
            header('location: ' . URL . 'projects/task/' . $task_id);
          }
      } else {
        header('location: ' . URL . 'projects');
      ...
      if(isset($task_id) && $task_id != null) {
          if($task_id != 1) {
            ...
            if($project_task_data != false) {
              ...
              $_SESSION['alert'] = 'The demo project task can not be deleted.';
              header('location: ' . URL . 'projects/view/' . $project_data->id);
          }
      } else {
        header('location: ' . URL . 'projects');
      ...
      if(isset($_POST['submit_edit_worker'])) {
          if($worker_id != 1) {
            ...
            if($worker != false) {
              ...
              $_SESSION['alert'] = 'That demo project worker can not be edited.';
              header('location: ' . URL . 'projects/view/' . $worker->project_id);
          }
      }
    } else {
      ...
      if(isset($worker_id) && $worker_id != null) {
          if($worker_id != 1) {
            ...
            if($project_worker_data != false) {
              ...
              $_SESSION['alert'] = 'The demo project worker can not be deleted.';
              header('location: ' . URL . 'projects/view/' . $project_data->id);
          }
      } else {
        header('location: ' . URL . 'projects');
      ...
      if(isset($project_id) && $project_id != null) {
          if($project_id != 1) {
            ...
            if($project_data != false) {
              ...
              $_SESSION['alert'] = 'The demo project can not be deleted.';
              header('location: ' . URL . 'projects');
          }
      } else {
        header('location: ' . URL . 'projects');
